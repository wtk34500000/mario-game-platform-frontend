...
var grow = new Audio();
grow.src = "sounds/mushroomGrow.mp3"
// let initScore = 10
// let count = 0
function preload ()
{
  ...
  this.load.image('mushroom', 'assets/sceneImages2/mushroom.png');
...
function create ()
{
  ...
  this.anims.create({
      key: 'left',
      frames: this.anims.generateFrameNumbers('dude', {frames: [0, 1, 2, 4]}),
      frameRate: 10,
      repeat: -1
  });
  this.anims.create({
  ...
  this.anims.create({
      key: 'right',
      frames: this.anims.generateFrameNumbers('dude', {frames: [3, 6, 7, 8]}),
      frameRate: 10,
      repeat: -1
  });
  //  Input Events
...
function collectStar (player, star0)
{
  ...
  if (stars.countActive(true) === 0)
  {
      ...
      stars.children.iterate(function (child) {
        ...
        // debugger
        if (count % 3 === 0){
          let mushroom = stars.children.entries[0].setTexture("mushroom")
          // stars.children.entries[1].setTexture("star" + count)
          // stars.children.entries[2].setTexture("star" + count)
          mushroom.setBounceY(0);
        }
        else if (count >= 6){
